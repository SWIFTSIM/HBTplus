...
cmake -B$PWD/configs/test/build -S$PWD
cmake $PWD/configs/test/build -D HBT_USE_OPENMP=ON -D HBT_UNSIGNED_LONG_ID_OUTPUT=OFF \
-D HBT_UNSIGNED_LONG_ID_OUTPUT=OFF
