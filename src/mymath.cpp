 ...
 *return Axis[3][3]: 3 eigenvectors (Axis[i] being vector-i), normalized such that the norm of each eigenvector gives
 *its eigenvalue. the eigenvalues are sorted in descending order
 */
{
