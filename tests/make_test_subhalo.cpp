...
void make_test_subhalo(std::mt19937 &rng,
                       Subhalo_t &sub, const HBTInt nr_particles,
                       const HBTxyz pos, const HBTReal radius,
                       const HBTxyz vel, const HBTReal vel_range) {
